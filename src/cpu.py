...
class InstructionMap(object):
    ...
    def jp_cc_oim8(self, flag, val):
        f = self.c.f[flag]
        if f == val:
            self.c.pc = self.m.read(self.c.pc + 1) - 2
